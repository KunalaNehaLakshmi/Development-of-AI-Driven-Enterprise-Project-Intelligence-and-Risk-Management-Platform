...
def render_landing_page():
    ...
    # -------------------------------------------------------------------------
    st.markdown("""<div class="landing-navbar-container"><div class="nav-brand">🛡️ AI Project Intelligence &amp; Risk Advisor</div><div class="nav-links-row"><a href="#hero" class="nav-btn" target="_self">Home</a><a href="#features" class="nav-btn" target="_self">Features</a><a href="#how-it-works" class="nav-btn" target="_self">How It Works</a><a href="#about" class="nav-btn" target="_self">About</a><a href="?page=auth&mode=login" class="nav-btn" target="_self">Login</a><a href="?page=auth&mode=register" class="nav-btn" target="_self">Get Started</a></div></div>""", unsafe_allow_html=True)
